...
def main():
    ...
    # Define the goal pose 3

    goal_pose = PoseStamped()
    goal_pose.header.frame_id = 'map'
    goal_pose.header.stamp = navigator.get_clock().now().to_msg()
    goal_pose.pose.position.x = -1.5473958253860474
    goal_pose.pose.position.y = 3.438857078552246
    goal_pose.pose.orientation.z = -0.012702573579062883
    goal_pose.pose.orientation.w = 0.999919319057527
